        ...
        return (
            <div class="page home">
                <div class='contentbar'>
                    <Graph
                        locations={locations}
                        series={["paleolatitude", "paleolatitudeCI", "temperature"]}
                    />
                    <Map
                        locations={locations}
                ...
                <div class="section flex features content_width_standard">
                    <div class='feature'>
                        ...
                        <div>
                            Click anywhere on the world map, or see the paleotemperature for your current location.
                        </div>
                    </div>
                    ...
                    <div class='feature'>
                        ...
                        <div>
                            Find out how the mean sea surface temperature of your location has changed over the eras.
                        </div>
                    </div>
                    ...
                    <div class='feature'>
                        ...
                        <div>
                            Compare the paleotemperature of multiple geologic plates. Up to 10 locations at a time can be compared by clicking on the world map.
                        </div>
                    </div>
                ...
                <div class='section explainer content_width_narrow'>
                    <h2>What is paleotemperature</h2>
