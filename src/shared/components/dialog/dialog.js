...
export const comp = {
    ...
    /*
        vnode.attrs = {
            ...
            responseoptions: [jsx],     //array of jsx elements to be placed in the reactions div, will overrule other responseoptions if set
    ...
    view: function view(vnode) {
        return (
            <dialog class={`comp dialog ${vnode.attrs.autowidth ? "autowidth" : ""} ${vnode.attrs.isLightbox ? "isLightbox" : ""}`}
                ...
                <div class='reactions'>
                    <Choose>
                        <When condition={vnode.attrs.responseoptions !== undefined}>
                            {vnode.attrs.responseoptions}
                        </When>
